...
func initOrgRouter(_ context.Context, t *testing.T, orgFinder *mockOrganizationFinder, authMiddleware gin.HandlerFunc) *gin.Engine {
	t.Helper()
	...
	findOrgHandler := orghandler.NewFindOrganizationHandler(orgFinder)
