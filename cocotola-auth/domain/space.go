...
func NewSpace(id int, organizationID int, ownerID int, keyName string, name string, spaceType SpaceType, deleted bool) (*Space, error) {
	m := &Space{
		id:             id,
...
func ReconstructSpace(id int, organizationID int, ownerID int, keyName string, name string, spaceType SpaceType, deleted bool) *Space {
	return &Space{
		id:             id,
		organizationID: organizationID,
		ownerID:        ownerID,
...
func (s *Space) SpaceType() SpaceType { return s.spaceType }
