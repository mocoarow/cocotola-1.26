...
func NewSessionToken(id string, userID int, loginID LoginID, organizationName string, tokenHash TokenHash, createdAt time.Time, expiresAt time.Time) (*SessionToken, error) {
	m := &SessionToken{
		id:               id,
		userID:           userID,
		loginID:          loginID,
...
func ReconstructSessionToken(id string, userID int, loginID LoginID, organizationName string, tokenHash TokenHash, createdAt time.Time, expiresAt time.Time, revokedAt *time.Time) *SessionToken {
	return &SessionToken{
		id:               id,
		userID:           userID,
		loginID:          loginID,
...
func (t *SessionToken) LoginID() LoginID { return t.loginID }
...
func (t *SessionToken) TokenHash() TokenHash { return t.tokenHash }
