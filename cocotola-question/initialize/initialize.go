...
func Initialize(
	...
	studyhandler.InitStudyRouter(getStudyQuestionsHandler, getStudySummaryHandler, recordAnswerHandler, deleteStudyHistoryHandler, parent, authMiddleware, orgResolverMiddleware)
